...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> querySpuList(@PathVariable("categoryId")Long categoryId,PageParamVo paramVo){
        PageResultVo resultVo=this.spuService.querySpuList(categoryId, paramVo);
